// Barrel — base UI primitives + foundation (icon)
export { FgButtonComponent, type ButtonVariant, type ButtonSize } from './button/button.component';
export { FgCardComponent } from './card/card.component';
export { FgChipComponent } from './chip/chip.component';
